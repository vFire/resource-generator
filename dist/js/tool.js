...
/* harmony default export */ __webpack_exports__["a"] = ({
    getTables: function getTables() {
        return window.axios.post('/nova-vendor/resource-generator/get-tables').then(function (response) {
            return response.data;
        });
    },
    getColumns: function getColumns(table) {
        return window.axios.post('/nova-vendor/resource-generator/get-columns', {
            table: table
    ...
    checkFiles: function checkFiles(createModel, singular) {
        return window.axios.post('/nova-vendor/resource-generator/check-file', {
    ...
    generateResources: function generateResources(table, singular, title, search, createModel, columns) {
        return window.axios.post('/nova-vendor/resource-generator/generate-resource', {
            table: table,
            singular: singular,
            title: title,
            search: search,
    ...
    getSettings: function getSettings() {
        return window.axios.get('/nova-vendor/resource-generator/settings-get').then(function (response) {
            return response.data;
        });
    },
    saveSettings: function saveSettings(settings) {
        return window.axios.post('/nova-vendor/resource-generator/settings-set', {
            settings: settings
        }).then(function (response) {
            return response.data;
        });
    ...
    resetSettings: function resetSettings() {
        return window.axios.post('/nova-vendor/resource-generator/settings-reset').then(function (response) {
            return response.data;
        });
    }
});
...
var update = __webpack_require__(2)("52c8e61f", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("08160a40", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("7eda136a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("1d2c4c89", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("2256a327", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("139086af", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
